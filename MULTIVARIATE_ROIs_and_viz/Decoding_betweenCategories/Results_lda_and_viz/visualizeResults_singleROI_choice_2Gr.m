...
% load('CON>CB1_MaskFGall_fromSearchlight_250bestvx.mat');%to visualize the dotplots in figure SI2 panel E
% load('CON>CB2_MaskFGall_fromSearchlight_250bestvx.mat');%to visualize the dotplots in figure SI2 panel F
load('CAT>CB1_MaskFGall_fromSearchlight_250bestvx.mat'); %to visualize the dotplots in figure SI2 panel G
% load('CAT>CB2_MaskFGall_fromSearchlight_250bestvx.mat');%to visualize the dotplots in figure SI2 panel H


title_string='Decoding between cat ';

%% Set the group combo you want to visualize 
Group_combo= 4; 
%1=CON-CAT
%2=CON-CB1
%3=CON-CB2
...
%5=CAT-CB2
    ...
    dataCAT=(CAT_all_accuracy)*100;

    dataCON=(CON_all_accuracy)*100;
    
    dataC1B=(C1B_all_accuracy)*100;

    dataC2B=(C2B_all_accuracy)*100;
...
FontSize=40; %%set the size of the labels
